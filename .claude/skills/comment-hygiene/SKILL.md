...
- **`taxonomy.md`** — the 16 named failure modes with verbatim examples, dispositions, and
...
Measured on one F# project. The reviewer-audience hypothesis and the mode list reference no
