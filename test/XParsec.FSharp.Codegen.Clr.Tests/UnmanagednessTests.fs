            ...
            test "intrinsics bound to reference types, arrays, functions and typars are Managed" {
                let managed =
                    [
                        ...
                        FTTypar(TyparScope.Type(SymbolKeyOps.qualifiedTypeKeyOf "T" 1), 0<typeSlot>)
                    ]
            ...
            test "census over the struct-union data corpus" {
                ...
                Expect.equal
                    ...
                    [
                        ...
                        "Mixed.I.x: Unmanaged"
                        "Mixed.S.x: Managed"
                        "External.Scalars.x: Unmanaged"
                        "External.Scalars.y: Unmanaged"
                        "External.Nested.inner: Unmanaged"
                        "External.Text.s: Managed"
                        "External.Id.id: Undetermined(Guid)"
                        "External.Stamp.at: Undetermined(DateTime)"
