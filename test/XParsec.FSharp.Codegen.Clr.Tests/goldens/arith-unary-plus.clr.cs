...
public static class Program
{
	...
	public static int Main(string[] args)
	{
		...
		formatter3.AppendFormatted((int)plusB(200));
		formatter3.AppendLiteral("\n");
		formatter3.Flush();
		Formatter formatter4 = new Formatter(0, 1, Console.Out);
		formatter4.AppendFormatted((int)plusS(sbyte.MinValue));
		formatter4.AppendLiteral("\n");
		formatter4.Flush();
		Formatter formatter5 = new Formatter(0, 1, Console.Out);
		formatter5.AppendFormatted((int)plusH(ushort.MaxValue));
		...
		formatter10.AppendFormatted(plusG(1000000007));
