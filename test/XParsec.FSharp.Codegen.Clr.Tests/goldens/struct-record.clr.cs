...
public static class Program
{
	...
	public static int Main(string[] args)
	{
		...
		P x = a;
		P y = b;
		formatter3.AppendBool(EqualityComparer<P>.Default.Equals(x, y), 0);
		...
		P x2 = a;
		P y2 = c;
		formatter4.AppendBool(EqualityComparer<P>.Default.Equals(x2, y2), 0);
		...
		int num = x3;
		int num2 = y3;
		formatter5.AppendFormatted(num + num2);
