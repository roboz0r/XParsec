...
let private generated: Lazy<string> =
    lazy
        compileLibrary coreDepsJsProvider.Value "Vesper.Printf" (IO.File.ReadAllText(srcFile "Vesper.Printf" "structural-printer.js.fs"))
    ...
    testList
        ...
        [
            ...
            test "the generated module renders every shape under Node (flat parity)" {
                ...
                match runNodeFiles "printf-js-phase3" [ "driver.mjs", driver; "Vesper.Printf.mjs", generated.Value ] with
