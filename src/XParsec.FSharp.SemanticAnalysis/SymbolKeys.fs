...
/// `TypeKey`s does NOT reconcile a language capability's two nominal keys (its BCL
...
/// `=`, or a capability spelled as its BCL interface will read as a distinct type.
and TypeKey =
    {
        Holder: TypeHolder
        Name: string
