...
let mapType (checker: Ts.TypeChecker) (t: Ts.Type) : Schema.TypeRef =
    match checker.typeToString t with
    ...
    | other -> Schema.TypeRef.Named(other, []) // TODO: unions → TyOr, generics, structurals
