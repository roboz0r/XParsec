// -----------------------------------------------------------------------------
// VENDORED THIRD-PARTY CODE — not subject to this repo's formatting or
// warnings-as-errors conventions.
//
// Source : Glutinum (https://github.com/glutinum-org/cli)
//          src/Glutinum.Converter/TypeScript.fs
// Purpose: ts2fable-generated bindings for the TypeScript compiler API (Fable).
// License: MIT. Copyright (c) Maxime Mangel and Glutinum contributors.
//          Included under the MIT License; see the upstream LICENSE for the
