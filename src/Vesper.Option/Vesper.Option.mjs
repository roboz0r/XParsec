...
export const Option__get_Value = (_s0) => ((_m63) => {
  ...
  if ((_m63.tag === 0)) {
    return ((() => { throw (new $Vesper_Core_InvalidOperationException("Option.Value: the option value was None")); })());
  }
...
export const get = (option) => ((_m72) => {
  if ((_m72.tag === 0)) {
    return ((() => { throw (new $Vesper_Core_InvalidOperationException("Option.get: the option value was None")); })());
  }
  if ((_m72.tag === 1)) {
    const v = _m72.Value;
    return v;
