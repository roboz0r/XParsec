...
export const flatWidth = (d) => ((_m6518) => {
  if ((_m6518.tag === 0)) {
    const s = _m6518.Item;
    return strLen(s);
  }
  if ((_m6518.tag === 1)) {
    const flat = _m6518.Item;
    return strLen(flat);
  }
  if ((_m6518.tag === 2)) {
    const kids = _m6518.Item;
    return catWidth(kids)(0)(0);
  }
  if ((_m6518.tag === 3)) {
    const inner = _m6518.Item2;
    return flatWidth(inner);
  }
  if ((_m6518.tag === 4)) {
    const inner = _m6518.Item1;
    const parens = _m6518.Item2;
