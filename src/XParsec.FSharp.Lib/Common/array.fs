// Transliterated from D:\roboz0r\fsharp\src\FSharp.Core\array.fs
...
module Array =
    ...
    [<CompiledName("OfList")>]
    let ofList list = List.toArray list
    ...
    [<CompiledName("Where")>]
    let where predicate (array: _ array) = filter predicate array
    ...
    [<CompiledName("Item")>]
    let item index (array: _ array) = array.[index]
    ...
    [<CompiledName("Get")>]
    let get (array: _ array) index = array.[index]

    [<CompiledName("Set")>]
    let set (array: _ array) index value = array.[index] <- value
    ...
    module Parallel =
        ...
        [<CompiledName("Reduce")>]
        let inline reduce ([<InlineIfLambda>] reduction) (array: _ array) = array |> reduceBy id reduction
        ...
        [<CompiledName("Sum")>]
        let inline sum (array: ^T array) : ^T = array |> sumBy id
        ...
        [<CompiledName("Average")>]
        let inline average (array: 'T array) = array |> averageBy id
        ...
        let private createPartitions (array: 'T array) = createPartitionsUpTo array.Length array
        ...
        [<CompiledName("SortDescending")>]
        let sortDescending array = array |> sort |> reverseInPlace
